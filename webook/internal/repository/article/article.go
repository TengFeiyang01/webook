...
func (c *CachedArticleRepository) Create(ctx context.Context, art domain.Article) (int64, error) {
	...
	id, err := c.dao.Insert(ctx, article.Article{
		Title:    art.Title,
		Content:  art.Content,
...
func NewCachedArticleRepository(dao article.ArticleDAO, l logger.LoggerV1, usrDAO dao.UserDAO, cache cache.ArticleCache) ArticleRepository {
