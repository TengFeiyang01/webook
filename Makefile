...
#	@mockgen -source=webook/internal/repository/art/art.go -package=artmocks -destination=webook/internal/repository/art/mocks/art.mock.go
#	@mockgen -source=webook/internal/repository/art/article_author.go -package=artmocks -destination=webook/internal/repository/art/mocks/article_author.mock.go
#	@mockgen -source=webook/internal/repository/art/article_reader.go -package=artmocks -destination=webook/internal/repository/art/mocks/article_reader.mock.go
